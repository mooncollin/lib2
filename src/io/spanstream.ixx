...
namespace lib2
{
    ...
    public:
        ...
        explicit basic_ospanstream(std::span<T> buf) noexcept
        {
            span(buf);
        }
        ...
        constexpr void span(std::span<T> s) noexcept
        {
    ...
    public:
        ...
        explicit basic_ispanstream(std::span<const T> buf) noexcept
        {
            span(buf);
        }
        ...
        constexpr void span(std::span<const T> s) noexcept
        {
