...
struct std::formatter<lib2::basic_string_literal<CharT, N>, CharT> : public std::formatter<std::basic_string_view<CharT>>
{
    template<class FormatCtx>
    auto format(const lib2::basic_string_literal<CharT, N>& str, FormatCtx& ctx) const
    {
        return std::formatter<std::basic_string_view<CharT>>::format(str.view(), ctx);
    }
};